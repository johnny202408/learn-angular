...
ראית את RxJS פעמיים כבר: `HttpClient` החזיר Observables, וגלגלנו אותם עם `firstValueFrom`. זה מספיק עבור HTTP של בקשה-תגובה, אבל לא לחלקים של Compass שעדיין לפניכם. חיפוש תוך כדי הקלדה, זרמים חיים, עדכוני טפסים מתואמים, ופרמטרי מסלול — כולם הם באופן טבעי זרמים של ערכים לאורך זמן, ו-RxJS היא הכלי של Angular לזרמים.
...
פרק 12 מסיים את חלק שלישי עם טפסים ריאקטיביים. Compass יש לו כרגע input "Add task" שנעשה ידנית. בפרק 12 אנחנו מחליפים אותו ב-`FormGroup`, מוסיפים ולידציה, ובונים דיאלוג עריכה למשימות עם תאריכי יעד ותגיות. אחרי פרק 12, Compass יש לו בקאנד אמיתי, טפסים אמיתיים, והתנהגות ריאקטיבית אמיתית — כל מה שאפליקציה קטנה צריכה לפני שהיא גדלה למספר עמודים, שזו העבודה של חלק רביעי.
