...
`TaskStore` היה צעד ראשון טוב. הוא עובד כי ל-Compass יש סוג אחד של נתונים. ליישומים אמיתיים יש רבים — משימות, הרגלים, משתמשים, הגדרות, טיוטות, העלאות, התראות — והם מתקשרים. ברגע שכמה חנויות צריכות לחלוק ערכים או להגיב זו לזו, אתה צריך *דפוס*, לא שירות חכם אחד.
...
הדפוס שהספר הזה משתמש בו הוא פשוט ומרחיב יותר ממה שמתחילים מצפים. עבור כל תחום בדומיין, יש לך מחלקת Injectable אחת — קרא לה Store — שהיא בעלים של מספר קטן של סיגנלים פרטיים, חושפת סיגנלים לקריאה בלבד לקריאות, וחושפת מתודות למוטציות.
